...
(def about-md '("#About Me" "  "
                            "##Current Position: Full Stack Node/Vue JS Developer at IBM" "  "
                            "###Interest In Clojure:"
...
(def about-html (->> (reduce (fn [a i] (str a i "\n\n")) "" about-md) (m/md->hiccup) (m/component)))

(js/console.log about-html)

(defn main [] 
  [:div {:class "m-4"} about-html])